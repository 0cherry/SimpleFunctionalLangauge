...
class TransitionOutput {
	...
	static TransitionOutput GOTO_STRING = new TransitionOutput(State.STRING);
	static TransitionOutput GOTO_ACCEPT_STRING = new TransitionOutput(State.ACCEPT_STRING);
	...
	static TransitionOutput GOTO_ACCEPT_BOOLEAN = new TransitionOutput(State.ACCEPT_BOOLEAN);
	...
	private TransitionOutput(State nextState, Token token) {
		this.nextState = nextState;
		this.token = Optional.of(token);
	}
	
	private TransitionOutput(State nextState) {
		this.nextState = nextState;
